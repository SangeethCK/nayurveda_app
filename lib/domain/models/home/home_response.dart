...
class HomeResponse {
    ...
    factory HomeResponse.fromJson(Map<String, dynamic> json) => HomeResponse(
        ...
        patient: json["patient"] == null ? [] : List<PatientLists>.from(json["patient"]!.map((x) => PatientLists.fromJson(x))),
    );
...
class PatientLists {
    ...
    factory PatientLists.fromJson(Map<String, dynamic> json) => PatientLists(
        id: json["id"],
